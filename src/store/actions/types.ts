...
export const TOGGLE_DISABLED = 'BEHAVIOR/TOGGLE_DISABLED';
...
export interface ToggleDisabled {
...
export type BehaviorActions = ToggleChat | ToggleInputDisabled | ToggleMsgLoader | ToggleDisabled;
